        ...
        <div id="pad-wrapper" class="new-user">
            ...
            <div class="row-fluid form-wrapper">
                ...
                <div class="span9 with-sidebar">
                    <div class="container">
                        <?php
                        echo form_open('c=Article&m=EditArticle');
                        ?>
                        ...
                        <div class="span12 field-box">
                            <label>题目:</label>
                            <input class="span9" name="title" type="text" value="<?php echo $content['title'];?>"/>
                            <input class="span9" name="articleid" type="hidden" value="<?php echo $content['aid'];?>"/>
                        </div>
                        ...
                        <div class="span11 field-box actions">
                            <input type="submit" class="btn-glow primary" value="Update Article" />
                            <span>OR</span>
